...
class Mascota{
    constructor(nombre, genero, image,especie, raza, size, vacunas, edad, desparasitado, esterilizado, rescatista, expediente){
        this._idPet = generateUUID();
        this.nombre = nombre;
        this.genero = genero;
        this.image = image;
    ...
    set rescatista(value){
        this._rescatista = value;
    }
    get rescatista(){
        return this._rescatista;
    }
    ...
    static createFromObject(obj){
        ...
        let pet = new Mascota(newPet._nombre, newPet._genero, newPet._image, newPet._especie, newPet._raza, newPet._size, newPet._vacunas, newPet._edad, newPet._desparasitado, newPet._esterilizado, newPet._expediente);
        //asignamos valores
        for(let property in newPet){
            pet[property] = newPet[property];
        }
        return pet;
    }
